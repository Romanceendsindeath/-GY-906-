...
{
	OLED_Clear();
	OLED_ShowCHinese16x16(0,0,0,LOGO); //测
	OLED_ShowCHinese16x16(16,0,1,LOGO);//量
	OLED_ShowCHinese16x16(32,0,2,LOGO);//模
	OLED_ShowCHinese16x16(48,0,3,LOGO);//式
	
	OLED_ShowCHinese16x16(0,2,4,LOGO); //检
	OLED_ShowCHinese16x16(16,2,5,LOGO);//测
	OLED_ShowCHinese16x16(32,2,6,LOGO);//模
	OLED_ShowCHinese16x16(48,2,7,LOGO);//式
	
	OLED_ShowCHinese16x16(0,4,10,LOGO); //报警温度
	OLED_ShowCHinese16x16(16,4,11,LOGO);
	OLED_ShowCHinese16x16(32,4,12,LOGO);
	OLED_ShowCHinese16x16(48,4,13,LOGO);
	
	OLED_ShowCHinese16x16(0,6,21,LOGO); //历史温度
...
void OLED_Mode1()
{
	OLED_ShowCHinese16x16(0,4,14,LOGO); //请按按键测温
...
void display(void)  
{	
	OLED_ShowCHinese16x16(0,0,8,LOGO); //温
	OLED_ShowCHinese16x16(16,0,9,LOGO);//度

}
void Reading(void)
{
	OLED_ShowString(0,2,"            ",16);
	OLED_ShowCHinese16x16(0,2,25,LOGO);//读取中...
...
{
	OLED_ShowCHinese16x16(0,2,4,LOGO);  //检测中
	OLED_ShowCHinese16x16(16,2,5,LOGO);
	OLED_ShowCHinese16x16(32,2,27,LOGO);
}
void Fire(void)
{
		OLED_ShowCHinese16x16(0,6,23,LOGO);//温度过高！
